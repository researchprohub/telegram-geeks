...
const AI_PROVIDERS = [
  {
    id: "groq", name: "Groq Cloud", type: "High-Speed Free",
    ...
    description: "Hardware-accelerated LPU inference with near-instant token stream.",
    keyPlaceholder: "gsk_...",
  },
  {
    id: "sambanova", name: "SambaNova Cloud", type: "High-Speed Free",
    models: ["Meta-Llama-3.3-70B-Instruct", "DeepSeek-R1-Distill-Llama-70B", "Meta-Llama-3.1-8B-Instruct"],
    isFree: true, badge: "⚡ High Throughput (Free)",
    description: "Full-precision open frontier models powered by SN40L Reconfigurable Dataflow Units.",
    keyPlaceholder: "samba_...",
  },
  {
    id: "together", name: "Together AI", type: "Free Tier / Cloud",
    models: ["meta-llama/Llama-3.3-70B-Instruct-Turbo", "deepseek-ai/DeepSeek-R1", "Qwen/Qwen2.5-72B-Instruct-Turbo"],
    isFree: true, badge: "✨ Open Weights (Free)",
    description: "High-performance inference engine for leading open source weights.",
    keyPlaceholder: "together_...",
  },
  {
    id: "deepseek", name: "DeepSeek Official", type: "Commercial / Generous Free",
    models: ["deepseek-chat", "deepseek-reasoner"],
    isFree: true, badge: "🧠 DeepSeek V3 / R1",
    description: "State-of-the-art reasoning and chat capabilities at unbeatable pricing.",
    keyPlaceholder: "sk-...",
  },
  {
    id: "google_gemini", name: "Google Gemini", type: "Free Tier",
    models: ["gemini-2.0-flash", "gemini-1.5-flash", "gemini-1.5-pro"],
    isFree: true, badge: "🆓 15 RPM Free Tier",
    description: "Massive context window with high reasoning throughput from Google AI Studio.",
    keyPlaceholder: "AIzaSy...",
  },
  {
    id: "github", name: "GitHub Models", type: "Free Tier",
    models: ["gpt-4o-mini", "Meta-Llama-3.1-70B-Instruct", "Phi-3.5-mini-instruct", "Mistral-large"],
    isFree: true, badge: "🐙 Free with GitHub PAT",
    description: "Azure AI-backed model catalog free for all GitHub developers.",
    keyPlaceholder: "ghp_...",
  },
  {
    id: "cerebras", name: "Cerebras", type: "Free Tier",
    models: ["llama3.3-70b", "llama3.1-8b"],
    isFree: true, badge: "⚡ 2,000+ Tokens/sec",
    description: "Wafer-scale cluster inference delivering 2,000+ tokens/sec.",
    keyPlaceholder: "csk-...",
  },
  {
  ...
  },
  {
    ...
    isFree: true, badge: "🟢 1000 Free Credits",
  ...
  },
  {
    ...
    isFree: true, badge: "🌐 10k Neurons/Day Free",
    description: "Serverless model inference distributed across Cloudflare's edge.",
    keyPlaceholder: "Cloudflare API Token",
  },
  {
    id: "huggingface", name: "Hugging Face", type: "Free Tier",
    models: ["meta-llama/Llama-3.1-8B-Instruct", "mistralai/Mistral-7B-Instruct-v0.3"],
    isFree: true, badge: "🤗 Free Inference API",
    description: "Instant serverless endpoints for open-weight Hugging Face checkpoints.",
    keyPlaceholder: "hf_...",
  },
  {
  ...
  },
  {
    ...
    models: ["openrouter/auto", "meta-llama/llama-3.3-70b-instruct:free", "deepseek/deepseek-r1:free"],
  ...
  },
  {
    ...
    models: ["mistral-small-latest", "open-mistral-nemo", "codestral"],
