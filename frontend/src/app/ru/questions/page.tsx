            ...
            <div className="grid lg:grid-cols-[auto_1fr] gap-8 items-start">
              ...
              <div>
                <h2 className="text-xl font-semibold text-foreground mb-4">
                  FAQ: Всё о массовых рассылках и приглашениях в Telegram через Telegram Geeks
                </h2>
                <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
                  ...
                  <p>
                    Telegram Geeks — это надёжное программное обеспечение для автоматизации рассылок, расширения базы и удобного управления кампаниями. Мы собрали практические рекомендации, чтобы работа с сервисом была максимально простой, эффективной и прозрачной для каждого пользователя.
                  </p>
                </div>
                <div className="mt-6">
                  <Link
