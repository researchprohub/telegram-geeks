...
const reviews = [
  { name: "mkaddy", license: "1 year", text: "Приобрел софт не так давно и не пожалел ни разу. Интерфейс достаточно понятный, можно разобраться просто методом тыка за пару минут. Отдельный плюс стабильность, ни зависаний, ни лагов за всё время использования не было. Ну и гибкость настроек прям радует, есть где развернуться под свои задачи." },
  { name: "Spam", license: "1 year", text: "Лучшее соотношение цены и наполнения по тг, работает стабильно, без сбоев и багов, понятный интерфейс, отзывчивая поддержка, использую не один год, за все время не было никаких проблем. Дает возможнасть оказывать огромный перечень услуг для клиентов, в большинстве случаев окупается одним заказом" },
];

export default function License1MonthPage() {
  return (
        ...
        <section className="pt-28 pb-8 lg:pt-36 lg:pb-10 relative">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
              ...
              <span className="text-foreground/70">License for 1 month</span>
            </nav>
            <div className="flex items-start gap-6">
              ...
              <div>
                <h1 className="text-3xl md:text-5xl font-bold tracking-tight text-foreground mb-3">
                  Promotion in Telegram with a license for 1 month
                </h1>
                <p className="text-muted-foreground max-w-2xl">
                  A 1-month license is suitable for getting familiar with the program and solving short-term tasks.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="grid lg:grid-cols-5 gap-8 p-8 lg:p-12">
                <div className="lg:col-span-3 space-y-6">
                  <p className="text-muted-foreground leading-relaxed">
                    A 1-month license is suitable for getting familiar with the program and solving short-term tasks. You receive access to the core functionality of the program for the entire license period.
                  </p>
                ...
                <div className="lg:col-span-2 lg:border-l border-border lg:pl-8">
                  <div className="rounded-xl border border-border bg-card p-6 text-center sticky top-28">
                    <div className="text-4xl font-bold text-foreground mb-1">120 <span className="text-lg text-muted-foreground">$</span></div>
                    <p className="text-muted-foreground text-sm mb-6">License for 1 month</p>
                    <ul className="text-left space-y-3 mb-6">
                      <li className="flex items-start gap-2 text-sm text-muted-foreground"><Check className="w-4 h-4 text-primary shrink-0 mt-0.5" />Access for 30 Days</li>
                      ...
                      <li className="flex items-start gap-2 text-sm text-muted-foreground"><MessageCircle className="w-4 h-4 text-primary shrink-0 mt-0.5" />Access to customer chat</li>
                    ...
                    <a
                      href="/cart?type=product&lang=en&pid=3"
