...
const reviews = [
  { name: "张江", license: "1 year", text: "我們為我們的專案購買了 2 年期許可證。之前，我們買了一個月，對結果很滿意。節目很棒！" },
  { name: "Jaiden Anderson", license: "1 year", text: "We purchased a 2-year license for our project. Previously, we purchased it for a month, and were pleased with the result. The program is great!" },
];

export default function License2YearPage() {
  return (
        ...
        <section className="pt-28 pb-8 lg:pt-36 lg:pb-10 relative">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
              ...
              <span className="text-foreground/70">License for 2 years</span>
            </nav>
            <div className="flex items-start gap-6">
              ...
              <div>
                <h1 className="text-3xl md:text-5xl font-bold tracking-tight text-foreground mb-3">
                  Promotion in Telegram with a license for 2 years
                </h1>
                <p className="text-muted-foreground max-w-2xl">
                  A 2-year license is designed for users planning stable and long-term work with the program.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="grid lg:grid-cols-5 gap-8 p-8 lg:p-12">
                ...
                <div className="lg:col-span-2 lg:border-l border-border lg:pl-8">
                  <div className="rounded-xl border border-border bg-card p-6 text-center sticky top-28">
                    <div className="text-4xl font-bold text-foreground mb-1">1050 <span className="text-lg text-muted-foreground">$</span></div>
                    <p className="text-muted-foreground text-sm mb-6">License for 2 years</p>
                    <ul className="text-left space-y-3 mb-6">
                      <li className="flex items-start gap-2 text-sm text-muted-foreground"><Check className="w-4 h-4 text-primary shrink-0 mt-0.5" />Access for 2 years</li>
                    ...
                    <a
                      href="/cart?type=product&lang=en&pid=5"
