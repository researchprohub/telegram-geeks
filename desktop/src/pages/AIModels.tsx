...
const AI_PROVIDERS = [
  { id: "groq", name: "Groq Cloud", type: "High-Speed Free", models: ["llama-3.3-70b-versatile", "llama-3.1-8b-instant", "deepseek-r1-distill-llama-70b"], badge: "🚀 Ultra Fast (Free)" },
  { id: "sambanova", name: "SambaNova", type: "High-Speed Free", models: ["Meta-Llama-3.3-70B-Instruct", "DeepSeek-R1-Distill-Llama-70B"], badge: "⚡ High Throughput" },
  { id: "together", name: "Together AI", type: "Free Tier / Cloud", models: ["meta-llama/Llama-3.3-70B-Instruct-Turbo", "deepseek-ai/DeepSeek-R1"], badge: "✨ Open Weights" },
  { id: "deepseek", name: "DeepSeek Official", type: "Free Tier / Ultra Low Cost", models: ["deepseek-chat", "deepseek-reasoner"], badge: "🧠 V3 & R1" },
  { id: "google_gemini", name: "Google Gemini", type: "Free Tier", models: ["gemini-2.0-flash", "gemini-1.5-flash"], badge: "🆓 15 RPM Free" },
  { id: "github", name: "GitHub Models", type: "Free Tier", models: ["gpt-4o-mini", "Meta-Llama-3.1-70B-Instruct"], badge: "🐙 GitHub Free" },
  { id: "cerebras", name: "Cerebras", type: "Free Tier", models: ["llama3.3-70b", "llama3.1-8b"], badge: "⚡ 2000+ t/s" },
  { id: "siliconflow", name: "SiliconFlow", type: "Free Tier", models: ["deepseek-ai/DeepSeek-V3", "deepseek-ai/DeepSeek-R1"], badge: "🇨🇳 Free DeepSeek" },
  { id: "nvidia_nim", name: "NVIDIA NIM", type: "Free Tier", models: ["meta/llama-3.1-8b-instruct"], badge: "🟢 1000 Credits" },
  { id: "cloudflare_workers_ai", name: "Cloudflare", type: "Serverless", models: ["@cf/meta/llama-3.1-8b-instruct"], badge: "🌐 10k Neurons Free" },
  { id: "huggingface", name: "Hugging Face", type: "Free Tier", models: ["meta-llama/Llama-3.1-8B-Instruct"], badge: "🤗 Free Inference" },
  { id: "ollama", name: "Ollama (Local)", type: "Offline / Self-Hosted", models: ["llama3.2", "llama3.1", "mistral"], badge: "🔒 100% Private" },
  { id: "openai", name: "OpenAI", type: "Commercial", models: ["gpt-4o", "gpt-4o-mini", "gpt-3.5-turbo"], badge: "⚡ Top Quality" },
  { id: "anthropic", name: "Anthropic", type: "Commercial", models: ["claude-3-5-sonnet-20241022", "claude-3-5-haiku-20241022"], badge: "🧠 Nuance" },
  ...
  { id: "mistral_ai", name: "Mistral AI", type: "Commercial", models: ["mistral-small-latest", "open-mistral-nemo"], badge: "🇫🇷 European" },
