...
# Test /personas
req4 = urllib.request.Request("http://localhost:8001/api/v1/personas/", headers=headers)
try:
...
# Test /groups
req5 = urllib.request.Request("http://localhost:8001/api/v1/groups/", headers=headers)
try:
...
# Test /modules
req6 = urllib.request.Request("http://localhost:8001/api/v1/modules/", headers=headers)
try:
